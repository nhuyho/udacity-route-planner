...
def shortest_path(M,start,goal):
    ...
    curr_cost = {}
    #Initialize origin and curr_cost dictionaries
    origin[start] = None
    curr_cost[start] = 0
    ...
    while len(frontier) > 0:
        ...
        for next in roads[current_node.value]:
            ...
            #This is: current cost + straight line distance cost 
            ...
            if next not in curr_cost.keys() or new_cost < curr_cost[next]:
                ...
                #************************************
                #Priority is new_cost + straight line distance cost next to goal 
